  ...
  - type: features_section
    features:
      ...
      - title: Time-tested Frameworks to understand businesses
        ...
        content: "A deep-dive into classical DCF & Multiples based Valuation techniques to analyze publicly listed firms in the Indian Stock Market +\_***Excel Workbook included***\n"
    ...
    grid_items:
      ...
      - title_align: left
        content: >
          ...
          Of course. You access to our forum to participate in continuous
          learning where we discuss practical case studies so that you can gain
          experience in doing your own independent analysis.
        content_align: left
        actions: []
        actions_align: left
        actions_width: auto
